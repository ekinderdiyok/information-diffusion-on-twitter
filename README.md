...
1. You are now reading `README.md` where I explain project structure and other relevant details.
...
3. `code/information-diffusion-on-twitter.ipynb`: is where I wrote my analysis script and visualized the results. This is a static document.
4. `code/information-diffusion-on-twitter.py`: Here, I exported the IPYNB file as a PY file for easier access.
